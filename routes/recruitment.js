...
router.post('/tablestages', function (req, res, next) {
    ...
    connection.query("select * from stages limit 2", function (error, results, fields) {
        if (error) res.json({"status": "failed", "message": error.message});
        else{
            res.json({"status": "ok", "data": results});
        }
...
router.post('/tablestagesnext', function (req, res, next) {
    ...
    connection.query('SELECT * from stages limit 2 OFFSET '+""+ req.body.counter +"" +'', function (error, results, fields) {
        if (error) res.json({"status": "failed", "message": error.message});
        else{
            res.json({"status": "ok", "data": results});
        }
...
router.post('/jobnext', function (req, res, next) {
    ...
    connection.query('select * from job_positions limit 2 OFFSET '+""+ req.body.counter +"" +'', function (error, results, fields) {
        if (error) res.json({"status": "failed", "message": error.message});
        else{
            res.json({"status": "ok", "data": results});
        }
...
router.post('/letter', function (req, res, next) {
    ...
    connection.query('SELECT application_documents.application_id, application_documents.document_url, application_documents.type, applications.application_tittle FROM application_documents INNER JOIN applications ON application_documents.application_id = applications.id limit 2', function (error, results, fields) {
        if (error) res.json({"status": "failed", "message": error.message});
        else{
            res.json({"status": "ok", "data": results});
        }
...
router.post('/abcs', function (req, res, next) {
    connection.query('SELECT application_documents.application_id, application_documents.document_url, application_documents.type, applications.application_tittle FROM application_documents INNER JOIN applications ON application_documents.application_id = applications.id  where  job_positions_id='+"'"+ req.body.id +"'" +' limit 2', function (error, results, fields) {
        if (error) res.json({"status": "failed", "message": error.message});
        else{
            res.json({"status": "ok", "data": results});
        }
...
router.post('/abcsnext', function (req, res, next) {
    connection.query('SELECT application_documents.application_id, application_documents.document_url, application_documents.type, applications.application_tittle FROM application_documents INNER JOIN applications ON application_documents.application_id = applications.id  where  job_positions_id='+"'"+ req.body.id +"'" +' limit 2 OFFSET '+""+ req.body.counter +"" +'', function (error, results, fields) {
        if (error) res.json({"status": "failed", "message": error.message});
        else{
            res.json({"status": "ok", "data": results});
        }
...
router.post('/dep', function (req, res, next) {
    ...
    connection.query("SELECT A.id AS id, A.name AS DepartmentName1, B.name AS DepartmentName2, A.manager_id, em.employeename FROM department A, department B, employee em WHERE A.parent_dept_id = B.id AND A.manager_id = em.id limit 2  ", function (error, results, fields) {
        if (error) res.json({"status": "failed", "message": error.message});
        else{
            res.json({"status": "ok", "data": results});
        }
...
router.post('/depnext', function (req, res, next) {
    ...
    connection.query('SELECT A.id AS id, A.name AS DepartmentName1, B.name AS DepartmentName2, A.manager_id, em.employeename FROM department A, department B, employee em WHERE A.parent_dept_id = B.id AND A.manager_id = em.id limit 2  OFFSET '+""+ req.body.counter +"" +'', function (error, results, fields) {
        if (error) res.json({"status": "failed", "message": error.message});
        else{
            res.json({"status": "ok", "data": results});
        }
...
router.post('/lettertable', function (req, res, next) {
    ...
    connection.query("SELECT application_documents.application_id as id, application_documents.document_url, application_documents.type, applications.application_tittle, applications.date_created, applications.owner FROM application_documents INNER JOIN applications ON application_documents.application_id = applications.id limit 2", function (error, results, fields) {
        if (error) res.json({"status": "failed", "message": error.message});
        else{
            res.json({"status": "ok", "data": results});
        }
...
router.post('/lettertablenext', function (req, res, next) {
    ...
    console.log('SELECT * from stages limit 2 OFFSET '+""+ req.body.counter +"" +'');
    connection.query('SELECT application_documents.application_id as id, application_documents.document_url, application_documents.type, applications.application_tittle, applications.date_created, applications.owner FROM application_documents INNER JOIN applications ON application_documents.application_id = applications.id limit 2 OFFSET '+""+ req.body.counter +"" +'', function (error, results, fields) {
        if (error) res.json({"status": "failed", "message": error.message});
        else{
            res.json({"status": "ok", "data": results});
        }
