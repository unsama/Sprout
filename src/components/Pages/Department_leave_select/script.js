    ...
    created: function () {
        ...
        $(function () {
            ...
            $(".Duplicate").click(function () {
                self.btnlinks.duplicatebtnlink ="/Employees/Department_leave_duplicate/"+self.$route.params.id
            });
            ...
            self.btnlinks.editbtnlink ="/Employees/Department_leave_edit/"+self.$route.params.id
        })
    },
    data () {
        return {
