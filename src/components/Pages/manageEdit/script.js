    ...
    created: function () {
        ...
        $(function() {
            $("#save").click(function () {
                ...
                if (r)
                {
                    window.location.href = "/attendance/select_attendance_info/"+self.$route.params.id;
                    self.submit();
                }
                else
                {
            ...
            self.btnlinks.discardbtnlink = "/attendance/select_attendance_info/"+self.$route.params.id;
